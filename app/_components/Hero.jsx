    ...
    >
      <div className="md:max-w-2xl max-w-md text-center grid gap-1">
        ...
        <p className="text-[0.8rem] max-w-md mx-auto">
          ...
          and projects, demonstrating my proficiency and commitment to coding
          <span className="text-primary">.</span>
        </p>
      </div>
      <div className="flex items-center justify-center gap-3 mt-5">
        <Button asChild variant="outline">
          <Link href="https://www.linkedin.com/in/abhishek2029/">Explore</Link>
        </Button>
        <Button asChild className="flex gap-1 items-center justify-center">
          <Link href="https://github.com/abhishekpandit2029">My Github</Link>
        </Button>
      </div>
    </section>
  );
