...
export default function Experience() {
  return (
    <div id="experience" className="mb-10">
      ...
      <div className="flex tab:px-8 lap:px-16 items-center justify-center">
        <div className="float-left hidden lg:flex">
          <Image src={ExperienceImg} className="w-100%" alt="Logo" />
        </div>
        <div className="flex flex-col space-y-4 px-6 tab:p-0 w-full lg:w-[50%]">
          <div className="bg-white rounded-lg text-black p-4 space-y-2 w-full lg:w-[80%] self-end">
          ...
          <div className="bg-white rounded-lg text-black p-4 space-y-2 w-full lg:w-[80%]">
            <div className="flex justify-between">
